Option Strict Off
Option Explicit On
Friend Class frmChoixSortieMateriel
...
15: Call frmSortieMateriel.Afficher(ModuleMain.enumCatalogue.ELECTRIQUE)
...
30: Call AfficherErreur("frmChoixSortieMateriel", "cmdElectrique_Click", Err, Erl())
	End Sub
...
15: Call frmSortieMateriel.Afficher(ModuleMain.enumCatalogue.MECANIQUE)
...
30: Call AfficherErreur("frmChoixSortieMateriel", "cmdMecanique_Click", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmChoixSortieMateriel", "cmdFermer_Click", Err, Erl())
	End Sub
	
	Private Sub frmChoixSortieMateriel_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
20: Call AfficherErreur("frmChoixSortieMateriel", "Form_Load", Err, Erl())
	End Sub
End Class