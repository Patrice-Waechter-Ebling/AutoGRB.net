...
Friend Class frmInventaireElec
...
115: If sWhere <> "" Then
120: Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif WHERE " & sWhere & " ORDER BY NoEnreg DESC", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
125: Else
130: Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif ORDER BY NoEnreg DESC", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
135: End If
		
		'Il faut vider le ListView avant de le remplir
140: Call lvwHistorique.Items.Clear()
		
		'Tant que ce n'est pas la fin des enregistrements
145: Do While Not rstHist.EOF
			'On l'ajoute
150: 'UPGRADE_ISSUE: MSComctlLib.ListItems method lvwHistorique.ListItems.Add was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			itmHist = lvwHistorique.Items.Add()
			
			'Date
155: itmHist.Text = rstHist.Fields("Date").Value
160: itmHist.Tag = rstHist.Fields("NoEnreg").Value
			
			'User
165: 'UPGRADE_WARNING: Lower bound of collection itmHist has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
...
175: If Trim(rstHist.Fields("IDProjet").Value) <> "" Then
180: 'UPGRADE_WARNING: Lower bound of collection itmHist has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
					...
					End If
185: Else
190: 'UPGRADE_WARNING: Lower bound of collection itmHist has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
					If itmHist.SubItems.Count > I_HIST_PROJET Then
...
195: End If
200: Else
205: 'UPGRADE_WARNING: Lower bound of collection itmHist has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
				If itmHist.SubItems.Count > I_HIST_PROJET Then
					itmHist.SubItems(I_HIST_PROJET).Text = "N/A"
				Else
					itmHist.SubItems.Insert(I_HIST_PROJET, New System.Windows.Forms.ListViewItem.ListViewSubItem(Nothing, "N/A"))
...
210: End If
			...
			'No Item
215: 'UPGRADE_WARNING: Lower bound of collection itmHist has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			...
			'Quantité
220: 'UPGRADE_WARNING: Lower bound of collection itmHist has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
...
240: 'UPGRADE_NOTE: Object rstHist may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		rstHist = Nothing
...
250: Call AfficherErreur("frmInventaireElec", "RemplirListViewHistorique", Err, Erl())
	End Sub
...
70: Call AfficherErreur("frmInventaireElec", "chkChoix_Click", Err, Erl())
	End Sub
...
105: Call AfficherErreur("frmInventaireElec", "cmdAfficherHistorique_Click", Err, Erl())
	End Sub
...
55: Call AfficherErreur("frmInventaireElec", "cmdImprimer_Click", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmInventaireElec", "cmdFermer_Click", Err, Erl())
	End Sub
	
	
	
	Private Sub frmInventaireElec_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
20: Call AfficherErreur("frmInventaireElec", "Form_Load", Err, Erl())
	End Sub
...
60: Call AfficherErreur("frmInventaireElec", "lvwHistorique_ColumnClick", Err, Erl())
	End Sub
...
20: Call g_connData.Execute("DELETE * FROM GRB_InventaireElecModif WHERE NoEnreg = " & lvwHistorique.FocusedItem.Tag)
...
60: Call AfficherErreur("frmInventaireElec", "lvwHistorique_KeyDown", Err, Erl())
	End Sub
...
45: Call rstInv.Open("SELECT * FROM GRB_InventaireElec WHERE NoItem = '" & Replace(sPiece, "'", "''") & "'", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
75: Call AfficherErreur("frmInventaireElec", "ModifierInventaire", Err, Erl())
	End Sub
...
35: Call AfficherErreur("frmInventaireElec", "mskDateDebut_GotFocus", Err, Erl())
	End Sub
...
65: Call AfficherErreur("frmInventaireElec", "mskDateDebut_LostFocus", Err, Erl())
	End Sub
...
35: Call AfficherErreur("frmInventaireElec", "mskDateFin_GotFocus", Err, Erl())
	End Sub
...
65: Call AfficherErreur("frmInventaireElec", "mskDateFin_LostFocus", Err, Erl())
	End Sub
...
25: Call rstInv.Open("SELECT NoItem, QuantitéStock, Description, Manufacturier, Localisation FROM GRB_InventaireElec ORDER BY Localisation, NoItem", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
65: Call AfficherErreur("frmInventaireElec", "cmdImprimer_Click", Err, Erl())
	End Sub
...
30: Call rstInv.Open("SELECT NoItem, Description, Manufacturier, [Prix Liste], Escompte, [Prix Net], Localisation, QuantitéStock, [Prix Net] * QuantitéStock As Total FROM GRB_InventaireElec WHERE QuantitéStock <> '0' ORDER BY NoItem", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
40: Call rstTotal.Open("SELECT SUM([Prix net] * QuantitéStock) As Total FROM GRB_InventaireElec", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
95: Call AfficherErreur("frmInventaireElec", "cmdImprimer_Click", Err, Erl())
	End Sub
	Private Function ExporterAjustementInventaire() As Object
		...
		Call rstInv.Open("SELECT NoItem, QuantitéStock, Description, Manufacturier, Localisation FROM GRB_InventaireElec ORDER BY Localisation, NoItem", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
		r = 1
...
AfficherErreur: 
	...
	Private Function ExporterValeurComptable() As Object
		...
		Call rstInv.Open("SELECT NoItem, Description, Manufacturier, [Prix Liste], Escompte, [Prix Net], Localisation, QuantitéStock, [Prix Net] * QuantitéStock As Total FROM GRB_InventaireElec WHERE QuantitéStock <> '0' ORDER BY NoItem", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
		...
		Call rstTotal.Open("SELECT SUM([Prix net] * QuantitéStock) As Total FROM GRB_InventaireElec", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
		...
		oXLSheet.Range("A:i").HorizontalAlignment = Excel.Constants.xlCenter
		'UPGRADE_WARNING: Array has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
