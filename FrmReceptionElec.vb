...
50: Call AfficherErreur("frmReceptionElec", "chkDateRequise_Click", Err, Erl())
	End Sub
...
40: Call AfficherErreur("frmReceptionElec", "chkProjetAchat_Click", Err, Erl())
	End Sub
...
50: Call AfficherErreur("frmReceptionElec", "cmbNoProjet_KeyUp", Err, Erl())
	End Sub
...
40: Else
45: Call rstProjAchat.Open("SELECT * FROM GRB_ProjetElec WHERE IDProjet = '" & cmbNoProjet.Text & "'", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
50: End If
...
165: Call AfficherErreur("frmReceptionElec", "cmbNoProjet_Click", Err, Erl())
	End Sub
...
85: Call AfficherErreur("frmReceptionElec", "cmbType_Click", Err, Erl())
	End Sub
...
170: Call AfficherErreur("frmReceptionElec", "cmdAfficher_Click", Err, Erl())
	End Sub
...
40: Call AfficherErreur("frmReceptionElec", "cmdAnnuler_Click", Err, Erl())
	End Sub
...
40: Call rstProjet.Open("SELECT Modification, Par FROM GRB_ProjetElec WHERE IDProjet = '" & txtnoprojet.Text & "'", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
55: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem.ListSubItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
				Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' And NuméroLigne = " & lvwProjet.FocusedItem.SubItems.Item(I_COL_MANUFACTURIER).Tag, g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
110: rstModif.Fields("Type").Value = "E"
...
200: m_iIndexReception = lvwProjet.FocusedItem.Index
				
205: Call RemplirListViewProjet(txtnoprojet.Text)
210: Else
215: Call MsgBox("Ce projet est en modification par " & rstProjet.Fields("Par").Value & "!", MsgBoxStyle.OKOnly, "Erreur")
220: End If
			
225: Call rstProjet.Close()
230: 'UPGRADE_NOTE: Object rstProjet may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
			rstProjet = Nothing
235: End If
...
245: Call AfficherErreur("frmReceptionElec", "AnnulerReceptionProjet", Err, Erl())
	End Sub
...
130: Else
135: Call MsgBox("Cet achat est en modification par " & rstAchat.Fields("Par").Value & "!", MsgBoxStyle.OKOnly, "Erreur")
140: End If
...
165: Call AfficherErreur("frmReceptionElec", "AnnulerReceptionAchat", Err, Erl())
	End Sub
...
30: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
			Call rstInventaire.Open("SELECT * FROM GRB_InventaireElec WHERE NoItem = '" & Replace(lvwProjet.FocusedItem.SubItems(I_COL_PIECE).Text, "'", "''") & "'", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
150: Call AfficherErreur("frmReceptionElec", "EnleverInventaireAchat", Err, Erl())
	End Sub
...
110: Call AfficherErreur("frmReceptionElec", "AjouterInventaireProjet", Err, Erl())
	End Sub
...
55: Call AfficherErreur("frmReceptionElec", "cmdDateRequise_Click", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "cmdFermerPieces_Click", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "cmdImprimer_Click", Err, Erl())
	End Sub
...
15: Call frmChoixDateImpressionReception.Afficher(txtnoprojet.Text, ModuleMain.enumCatalogue.ELECTRIQUE, enumType.ACHAT)
20: Else
25: Call frmChoixDateImpressionReception.Afficher(txtnoprojet.Text, ModuleMain.enumCatalogue.ELECTRIQUE, enumType.PROJET)
30: End If
...
40: Call AfficherErreur("frmReceptionElec", "ImprimerReception", Err, Erl())
	End Sub
...
195: 'UPGRADE_WARNING: Couldn't resolve default property of object DR_BackOrder.Sections. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			DR_BackOrder.Sections("Section4").Controls("lblTitre").Caption = "Achats électriques : Pièces non reçues"
...
265: Call AfficherErreur("frmReceptionElec", "cmdImprimerPieces_Click", Err, Erl())
	End Sub
...
50: Call AfficherErreur("frmReceptionElec", "cmdNonRecu_Click", Err, Erl())
	End Sub
...
325: Call AfficherErreur("frmReceptionElec", "RemplirListePiecesNonRecues", Err, Erl())
	End Sub
	
	Private Sub FrmReceptionElec_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
		Dim KeyCode As Short = eventArgs.KeyCode
		Dim Shift As Short = eventArgs.KeyData \ &H10000
...
40: Call AfficherErreur("frmReceptionElec", "Form_KeyDown", Err, Erl())
	End Sub
	
	Private Sub FrmReceptionElec_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
25: Call AfficherErreur("frmReceptionElec", "Form_Unload", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "lvwProjet_Click", Err, Erl())
	End Sub
...
40: Call AfficherErreur("frmReceptionElec", "lvwProjet_DblClick", Err, Erl())
	End Sub
...
65: Call rstProjet.Open("SELECT Modification, Par, Profit FROM GRB_ProjetElec WHERE IDProjet = '" & txtnoprojet.Text & "'", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
120: rstModif = New ADODB.Recordset
...
175: rstModif.Fields("Type").Value = "E"
...
260: rstCopiePiece = New ADODB.Recordset
										
265: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem.ListSubItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
										Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' AND NuméroLigne = " & lvwProjet.FocusedItem.SubItems.Item(I_COL_MANUFACTURIER).Tag, g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
										
270: sTotal = rstPiece.Fields("Qté").Value
										
275: rstPiece.Fields("Qté").Value = sQuantite
										
										'Si le temps n'est pas vide
285: If Trim(rstPiece.Fields("Temps").Value) <> vbNullString Then
											'On calcul le temps * quantité pour la colonne montage
290: rstPiece.Fields("Temps_total").Value = CDbl(Replace(rstPiece.Fields("Temps").Value, ".", ",")) * CDbl(Replace(rstPiece.Fields("Qté").Value, "*", vbNullString))
295: Else
300: rstPiece.Fields("Temps_total").Value = vbNullString
305: End If
										
										'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
310: rstPiece.Fields("Prix_Total").Value = Conversion_Renamed(CStr(System.Math.Round(CDbl(Replace(rstPiece.Fields("Qté").Value, "*", vbNullString)) * rstPiece.Fields("Prix_net").Value * CSng(sProfit), 2)), ModuleMain.enumConvert.MODE_PAS_FORMAT)
										
										'Pour le profit, c'est le prix total - (prix net * quantité)
315: rstPiece.Fields("Profit_argent").Value = Conversion_Renamed(CStr(System.Math.Round(rstPiece.Fields("Prix_total").Value - (rstPiece.Fields("Prix_net").Value * CDbl(Replace(rstPiece.Fields("Qté").Value, "*", vbNullString))), 2)), ModuleMain.enumConvert.MODE_PAS_FORMAT)
										
320: rstPiece.Fields("Recu").Value = True
325: rstPiece.Fields("Commandé").Value = False
330: rstPiece.Fields("DateRéception").Value = txtDateReception.Text
										
335: Call rstPiece.Update()
										
340: Call rstCopiePiece.Open("SELECT * FROM GRB_Projet_Pieces", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
										
345: Call rstCopiePiece.AddNew()
										
350: rstCopiePiece.Fields("IDProjet").Value = rstPiece.Fields("IDProjet").Value
355: rstCopiePiece.Fields("IDSection").Value = rstPiece.Fields("IDSection").Value
360: rstCopiePiece.Fields("NumItem").Value = rstPiece.Fields("NumItem").Value
365: rstCopiePiece.Fields("Qté").Value = CDbl(sTotal) - CDbl(sQuantite)
370: rstCopiePiece.Fields("Desc_FR").Value = rstPiece.Fields("Desc_FR").Value
375: rstCopiePiece.Fields("Desc_EN").Value = rstPiece.Fields("Desc_EN").Value
380: rstCopiePiece.Fields("Manufact").Value = rstPiece.Fields("Manufact").Value
385: rstCopiePiece.Fields("Prix_List").Value = rstPiece.Fields("Prix_List").Value
390: rstCopiePiece.Fields("Escompte").Value = rstPiece.Fields("Escompte").Value
395: rstCopiePiece.Fields("Prix_net").Value = rstPiece.Fields("Prix_net").Value
400: rstCopiePiece.Fields("IDFRS").Value = rstPiece.Fields("IDFRS").Value
405: rstCopiePiece.Fields("Temps").Value = rstPiece.Fields("Temps").Value
										
410: If Trim(rstCopiePiece.Fields("Temps").Value) <> vbNullString Then
											'On calcul le temps * quantité pour la colonne montage
415: rstCopiePiece.Fields("Temps_total").Value = CDbl(Replace(rstCopiePiece.Fields("Temps").Value, ".", ",")) * CDbl(Replace(rstCopiePiece.Fields("Qté").Value, "*", vbNullString))
420: Else
425: rstCopiePiece.Fields("Temps_total").Value = vbNullString
430: End If
										
										'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
435: rstCopiePiece.Fields("Prix_Total").Value = Conversion_Renamed(CStr(System.Math.Round(CDbl(Replace(rstCopiePiece.Fields("Qté").Value, "*", vbNullString)) * rstCopiePiece.Fields("Prix_net").Value * CSng(sProfit), 2)), ModuleMain.enumConvert.MODE_PAS_FORMAT)
										
440: rstCopiePiece.Fields("Profit_Pourcent").Value = rstPiece.Fields("Profit_Pourcent").Value
										
										'Pour le profit, c'est le prix total - (prix net * quantité)
445: rstCopiePiece.Fields("Profit_argent").Value = Conversion_Renamed(CStr(System.Math.Round(rstCopiePiece.Fields("Prix_total").Value - (rstCopiePiece.Fields("Prix_net").Value * CDbl(Replace(rstCopiePiece.Fields("Qté").Value, "*", vbNullString))), 2)), ModuleMain.enumConvert.MODE_PAS_FORMAT)
										
450: rstCopiePiece.Fields("SousSection").Value = rstPiece.Fields("SousSection").Value
455: rstCopiePiece.Fields("OrdreSection").Value = rstPiece.Fields("OrdreSection").Value
460: rstCopiePiece.Fields("NuméroLigne").Value = rstPiece.Fields("NuméroLigne").Value + 1
465: rstCopiePiece.Fields("PrixOrigine").Value = rstPiece.Fields("PrixOrigine").Value
470: rstCopiePiece.Fields("Type").Value = rstPiece.Fields("Type").Value
475: rstCopiePiece.Fields("Visible").Value = rstPiece.Fields("Visible").Value
480: rstCopiePiece.Fields("Commandé").Value = True
485: rstCopiePiece.Fields("Quoté").Value = rstPiece.Fields("Quoté").Value
490: rstCopiePiece.Fields("Recu").Value = False
495: rstCopiePiece.Fields("Retour").Value = False
500: rstCopiePiece.Fields("NoRetour").Value = vbNullString
505: rstCopiePiece.Fields("CommandeAnnulée").Value = False
510: rstCopiePiece.Fields("DateRéception").Value = vbNullString
520: rstCopiePiece.Fields("Facturation").Value = rstPiece.Fields("Facturation").Value
525: rstCopiePiece.Fields("ID").Value = ""
530: rstCopiePiece.Fields("PieceExtra").Value = rstPiece.Fields("PieceExtra").Value
535: rstCopiePiece.Fields("DateCommande").Value = rstPiece.Fields("DateCommande").Value
540: rstCopiePiece.Fields("DateRequise").Value = rstPiece.Fields("DateRequise").Value
545: rstCopiePiece.Fields("MatérielInutile").Value = False
...
565: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem.ListSubItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
										Call rstPiece.Open("SELECT * FROM GRB_Projet_Pieces WHERE IDProjet = '" & txtnoprojet.Text & "' AND Type = 'E' AND NuméroLigne >= " & lvwProjet.FocusedItem.SubItems.Item(I_COL_MANUFACTURIER).Tag + 1, g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
										
570: bSkip = False
										
575: Do While Not rstPiece.EOF
580: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
...
585: rstPiece.Fields("NuméroLigne").Value = rstPiece.Fields("NuméroLigne").Value + 1
...
620: Call rstPiece.Close()
										...
										'Ajout aux modifs
625: Call rstModif.Open("SELECT * FROM GRB_Projet_Modif", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
										
630: Call rstModif.AddNew()
										
635: Call rstEmploye.Open("SELECT noEmploye FROM GRB_Employés WHERE loginname = '" & g_sUserID & "'", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
										
640: rstModif.Fields("Type").Value = "E"
645: rstModif.Fields("IDProjet").Value = txtnoprojet.Text
650: rstModif.Fields("noEmployé").Value = rstEmploye.Fields("noEmploye").Value
655: rstModif.Fields("Date").Value = ConvertDate(Today)
660: rstModif.Fields("Heure").Value = TimeOfDay
665: rstModif.Fields("TypeModif").Value = "RECEPTION"
...
685: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
										If UCase(lvwProjet.FocusedItem.SubItems(I_COL_DISTRIBUTEUR).Text) = "SOLUTION GRB INC." Then
690: Call EnleverInventaireProjet(sQuantite)
695: End If
										
700: m_iIndexReception = lvwProjet.FocusedItem.Index
										
705: Call RemplirListViewProjet(txtnoprojet.Text)
										
710: 'UPGRADE_NOTE: Object rstCopiePiece may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
										rstCopiePiece = Nothing
715: Else
720: Call MsgBox("La quantité est trop grande!", MsgBoxStyle.OKOnly, "Erreur")
725: End If
730: End If
								
735: 'UPGRADE_NOTE: Object rstPiece may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
								rstPiece = Nothing
740: 'UPGRADE_NOTE: Object rstEmploye may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
								rstEmploye = Nothing
745: 'UPGRADE_NOTE: Object rstModif may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
								rstModif = Nothing
750: Else
755: Call MsgBox("La quantité doit être plus grande que 0!", MsgBoxStyle.OKOnly, "Erreur")
760: End If
765: Else
770: Call MsgBox("Quantité non numérique!", MsgBoxStyle.OKOnly, "Erreur")
775: End If
780: End If
785: End If
790: Else
795: Call MsgBox("Ce projet est en modification par " & rstProjet.Fields("Par").Value & "!", MsgBoxStyle.OKOnly, "Erreur")
800: End If
			
805: Call rstProjet.Close()
810: 'UPGRADE_NOTE: Object rstProjet may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
			rstProjet = Nothing
815: End If
...
825: Call AfficherErreur("frmReceptionElec", "ReceptionProjet", Err, Erl())
	End Sub
...
85: If System.Drawing.ColorTranslator.ToOle(lvwProjet.FocusedItem.ForeColor) = COLOR_ORANGE Then 'COLOR_ORANGE ou bleu
...
155: If (CShort(VB.Right(sIDAchat, 2)) >= 1 And CShort(VB.Right(sIDAchat, 2)) <= 12) Or rstPiece.Fields("IDFRS").Value = 717 Then
...
195: rstCopiePiece = New ADODB.Recordset
										
200: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem.ListSubItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
										Call rstPiece.Open("SELECT * FROM GRB_Achat_Pieces WHERE IDAchat = '" & sIDAchat & "' AND IndexAchat = " & iIndexAchat & " AND NuméroLigne = " & lvwProjet.FocusedItem.SubItems.Item(I_COL_MANUFACTURIER).Tag, g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
										
205: sTotal = rstPiece.Fields("Qté").Value
										
210: rstPiece.Fields("Qté").Value = sQuantite
										
										'Pour le prix total, il faut faire la quantité * prix net * pourcentage de profit
220: rstPiece.Fields("Prix_Total").Value = Conversion_Renamed(CStr(System.Math.Round(CDbl(Replace(rstPiece.Fields("Qté").Value, "*", vbNullString)) * rstPiece.Fields("Prix_net").Value, 2)), ModuleMain.enumConvert.MODE_PAS_FORMAT)
										
225: rstPiece.Fields("Recu").Value = True
230: rstPiece.Fields("Commandé").Value = False
235: rstPiece.Fields("DateRéception").Value = txtDateReception.Text
...
375: iIDFRS = rstPiece.Fields("IDFRS").Value
										
380: Call rstPiece.Close()
										
385: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem.ListSubItems has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
...
400: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
...
445: If (CShort(VB.Right(sIDAchat, 2)) >= 0 And CShort(VB.Right(sIDAchat, 2)) <= 12) Or iIDFRS = 717 Then
450: Call AjouterInventaireAchat(sQuantite)
455: End If
										
460: m_iIndexReception = lvwProjet.FocusedItem.Index
										
465: Call RemplirListViewAchat(txtnoprojet.Text)
										
470: 'UPGRADE_NOTE: Object rstCopiePiece may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
										rstCopiePiece = Nothing
475: Else
480: Call MsgBox("La quantité est trop grande!", MsgBoxStyle.OKOnly, "Erreur")
485: End If
									
490: 'UPGRADE_NOTE: Object rstPiece may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
									rstPiece = Nothing
495: End If
500: Else
...
535: End If
540: Else
545: Call MsgBox("Cet achat est en modification par " & rstAchat.Fields("Par").Value & "!", MsgBoxStyle.OKOnly, "Erreur")
550: End If
...
575: Call AfficherErreur("frmReceptionElec", "ReceptionAchat", Err, Erl())
	End Sub
...
90: 'UPGRADE_WARNING: Lower bound of collection lvwProjet.SelectedItem has changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A3B628A0-A810-4AE2-BFA2-9E7A29EB9AD0"'
				Call frmChoixLocalisation.Afficher(ModuleMain.enumCatalogue.ELECTRIQUE, lvwProjet.FocusedItem.SubItems(I_COL_PIECE).Text)
...
235: Else
240: rstInventaire.Fields("Prix Liste").Value = "0"
245: End If
...
315: rstPieceFRS.Fields("Type").Value = "E"
320: End If
...
410: Call AfficherErreur("frmReceptionElec", "EnleverInventaireProjet", Err, Erl())
	End Sub
...
380: rstPieceFRS.Fields("Type").Value = "E"
385: End If
...
475: Call AfficherErreur("frmReceptionElec", "AjouterInventaireAchat", Err, Erl())
	End Sub
...
20: Call rstHist.Open("SELECT * FROM GRB_InventaireElecModif", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
115: Call AfficherErreur("frmReceptionElec", "AjouterHistorique", Err, Erl())
	End Sub
...
155: Call AfficherErreur("frmReceptionElec", "SupprimerHistorique", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "cmdFermer_Click", Err, Erl())
	End Sub
	
	Private Sub FrmReceptionElec_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
...
140: Call AfficherErreur("frmReceptionElec", "Form_Load", Err, Erl())
	End Sub
...
25: Call rstProjet.Open("SELECT IDProjet FROM GRB_ProjetElec ORDER BY IDProjet DESC", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
80: Call AfficherErreur("frmReceptionElec", "RemplirComboProjet", Err, Erl())
	End Sub
...
25: Call rstAchat.Open("SELECT IDAchat, IndexAchat FROM GRB_Achat WHERE Type = 'E' ORDER BY IDAchat DESC, IndexAchat DESC", g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
80: Call AfficherErreur("frmReceptionElec", "RemplirComboAchat", Err, Erl())
	End Sub
...
105: Call rstSection.Open("SELECT NomSectionFR FROM GRB_SoumProjSectionElec WHERE IDSection = " & rstProjet.Fields("IDSection").Value, g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
215: Call rstSection.Open("SELECT NomSectionFR FROM GRB_SoumProjSectionElec WHERE IDSection = " & rstProjet.Fields("IDSection").Value, g_connData, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
...
805: Call AfficherErreur("frmReceptionElec", "RemplirListViewProjet", Err, Erl())
	End Sub
...
495: Call AfficherErreur("frmReceptionElec", "RemplirListViewProjet", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "lvwProjet_ItemClick", Err, Erl())
	End Sub
...
60: Call AfficherErreur("frmReceptionElec", "VerifierBoutonAnnuler", Err, Erl())
	End Sub
...
25: Call AfficherErreur("frmReceptionElec", "Afficher", Err, Erl())
	End Sub
...
30: Call AfficherErreur("frmReceptionElec", "AfficherProjet", Err, Erl())
	End Sub
...
30: Call AfficherErreur("frmReceptionElec", "AfficherAchat", Err, Erl())
	End Sub
...
50: Call AfficherErreur("frmReceptionElec", "lvwProjet_KeyDown", Err, Erl())
	End Sub
...
25: Call AfficherErreur("frmReceptionElec", "mvwReception_DateClick", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "mvwReception_LostFocus", Err, Erl())
	End Sub
...
25: Call AfficherErreur("frmReceptionElec", "mvwDateRequise_DateClick", Err, Erl())
	End Sub
...
20: Call AfficherErreur("frmReceptionElec", "mvwDateRequise_LostFocus", Err, Erl())
	End Sub
	
	Private Sub FrmReceptionElec_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Click
...
25: Call AfficherErreur("frmReceptionElec", "Form_Click", Err, Erl())
	End Sub
...
55: Call AfficherErreur("frmReceptionElec", "cmdDate_Click", Err, Erl())
	End Sub
End Class